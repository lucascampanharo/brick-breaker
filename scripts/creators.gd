...
func _build_content() -> void:
	...
	title_gap.custom_minimum_size = Vector2(0, 18)
	...
	members.custom_minimum_size = Vector2(260, 0)
	members.add_theme_constant_override("separation", 14)
	members_center.add_child(members)

	for member_name in MEMBER_NAMES:
		members.add_child(_build_member_button(member_name))
	...
	footer.add_child(_build_back_button())
...
func _build_member_button(text_value: String) -> Button:
	...
	if text_value.contains("Lucas Ferreira"):
